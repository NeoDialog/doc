...
Object.assign(NeoDialog,{
    ...
    alert : {
        ...
        success : function (options= {} ) {
            ...
            const rtl = ( options.hasOwnProperty("rtl") )
              ...
              const confirmText = (rtl) ? "تایید" : "Ok";
    ...
    dialog : {
        ...
        login : function (options= {}) {
            ...
            const confirmText = (rtl) ? "ورود" : "login";
            const cancelText = (rtl) ? "انصراف" : "cancel";
            const usernameText = (rtl) ? "نام کاربری :" : "username :";
            const passwordText = (rtl) ? "گذرواژه :" : "password :";
            const title = (rtl) ? "ورود" : "Login";
            const text = (rtl) ? "برای ورود نام کاربری و گذرواژه خود را وارد کنید." : "Enter your username and password to login.";
        ...
        sign_up : function (options) {
            ...
            const confirmText = (rtl) ? "ثبت نام" : "sign up";
            const cancelText = (rtl) ? "انصراف" : "cancel";
            const usernameText = (rtl) ? "نام کاربری :" : "username :";
            const passwordText = (rtl) ? "گذرواژه :" : "password :";
            const emailText = (rtl) ? "ایمیل :" : "email :";
            const firstText = (rtl) ? "نام :" : "name :";
            const lastText = (rtl) ? "نام خانوادگی :" : "last name :";
            const sexText = (rtl) ? "جنسیت :" : "gender :";
            const title = (rtl) ? "ثبت نام" : "Sign up";
            const text = (rtl) ? "بیایید شما را ثبت نام کنیم." : "let's get you set up.";
        ...
        validationCode : function (options = {}) {
            ...
            const confirmText = (rtl) ? "تایید" : "done";
            const cancelText = (rtl) ? "انصراف" : "cancel";
            const usernameText = (rtl) ? "کد :" : "code :";
            const title = (rtl) ? "کد اعتبار سنجی" : "validation Code";
            const text = (rtl) ? "لطفا کد اعتبار سنجی را وارد کنید." : "Please Enter Validation Code.";
    ...
    snackbar : {
        ...
        cookies : function (options= {}) {
            ...
            const confirmText = (rtl) ? "تایید" : "accept";
            const rejectText = (rtl) ? "رد کردن" : "deny";

            const title = (rtl) ? "کوکی ها" : "cookies";
            const text = (rtl) ? "کوکی ها به ما کمک می کنند تا توصیه های مربوط به محصولات را مطابق با سلیقه شخصی را نمایش دهیم و اطمینان حاصل کنیم که تجربه عالی داشته باشید." : "Cookies help us display personalized product recommendations and ensure you have great shopping experience";
        ...
        subscribe : function (options= {}) {
            ...
            const title = (rtl) ? "اشترک" : "subscribe";
            const text = (rtl) ? "لطفا برای اشتراک در خبرنامه ما ایمیل خود را وارد کنید." : "Please enter your email to subscribe to our newsletter.";
        ...
        if (e.hasAttribute("onlyValid")) {
            ...
            switch (only) {
                ...
                case 'email' :
                    ...
                    break;
                case 'ar-fa' :
                    if (! /^[ ﷲآابپتثجچحخدذرزژسشصضطظعغفقکگلمنوئهی]+$/u.test(e.value)) {
                        let error = e.getAttribute("invalid-error") || "invalid value!" ;
                        e.setCustomValidity(error);
                        e.reportValidity();
                        e.style.color = "red";
